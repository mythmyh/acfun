...
from bilibili.spiders.acfun import Store
...
class BiliPipeline(FilesPipeline):
...
class client:
    ...
    def getname(self):
        ...
        file_length = Store.file_length
        t3 = file_length / 100
        print(str(t3), '=======', str(file_length))
        t3 = Decimal(str(t3))
        j, c01 = 0, t3
        end = 100
        if t3 > 1:
...
class FilesPipeline2(MediaPipeline):
    ...
    def __init__(self, store_uri, download_func=None, settings=None):
        ...
        super(FilesPipeline2, self).__init__(download_func=download_func, settings=settings)
